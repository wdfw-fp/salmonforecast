#' Evaluate performance of SARIMA model (produces season total forecasts only)
#'
#' @param series A data frame containing the time series data.
#' @param leave_yrs Number of years to leave out for testing.
#' @param covariates A list of covariates to be used in the model.
#' @param first_forecast_period The starting forecast period.
#' @param plot_results Should results be plotted?
#' @param write_model_summaries Should model summaries be written to a file?
#' @param forecast_period_start_m Forecast period start month (inclusive).
#' @param forecast_period_start_d Forecast period start day (inclusive).
#' @param obs_period_2 Data for a second observed period (if available).
#' @param p1_covariates_only A vector of covariates for period 1.
#' @param stack_metric The metric to use for model stacking.
#'
#' @return A data frame with SARIMA model forecasts.
#'
#' @export
